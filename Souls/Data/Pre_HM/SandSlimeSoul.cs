...
{
	public class SandSlimeSoul : PreHMSoul
	{
		public override short soulNPC => NPCID.SandSlime;
		public override string soulDescription => "Fires a blinding, bouncing slime blob.";
		...
		public override bool SoulUpdate(Player p, short stack)
		{
			...
			Projectile.NewProjectile(p.Center, velocity, ModContent.ProjectileType<SandSlimeSoulProj>(), damage, .2f, p.whoAmI, bounceAmount);

			return (true);
		}
	}

	public class SandSlimeSoulProj : ModProjectile
	{
		Vector2 bounceVelocity;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Sandy Blob");
