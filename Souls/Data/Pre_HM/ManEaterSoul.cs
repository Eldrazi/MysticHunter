...
{
	public class ManEaterSoul : ISoul
	{
		public bool acquired { get; set; }

		public short soulNPC => NPCID.ManEater;
		public string soulDescription => "Summons a friendly Man Eater";
	...
	public class ManEaterSoulProj : ModProjectile
	{
		...
		public override bool PreAI()
		{
			...
			if (Main.myPlayer == player.whoAmI && (sp.BlueSoul == null || sp.BlueSoul.soulNPC != NPCID.ManEater))
				projectile.Kill();
