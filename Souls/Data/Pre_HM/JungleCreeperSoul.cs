...
{
	public class JungleCreeperSoul : PostHMSoul
	{
		public override short soulNPC => NPCID.JungleCreeper;
		public override string soulDescription => "Attack with venomous teeth.";
		...
		public override short[] GetAdditionalTypes()
			=> new short[] { NPCID.JungleCreeperWall };
	}

	public class JungleCreeperSoulProj : ModProjectile
	{
		public override string Texture => "MysticHunter/Souls/Data/Pre_HM/BloodCrawlerSoulProj";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Venomous Teeth");
	...
	public class JungleCreeperSoulProjBlood : ModProjectile
	{
		int randFrameY;
