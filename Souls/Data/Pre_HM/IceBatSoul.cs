...
namespace MysticHunter.Souls.Data.Pre_HM
{
	public class IceBatSoul : PreHMSoul
	{
		...
		public override bool SoulUpdate(Player p, short stack)
		{
			...
			for (int i = 0; i < amount; ++i)
			{
				...
				Projectile.NewProjectile(pos, velocity.RotatedByRandom(.2), ModContent.ProjectileType<IceBatSoulProj>(), damage, 0, p.whoAmI);
			}
	...
	public class IceBatSoulProj : ModProjectile
	{
		...
		public override bool PreAI()
		{
			...
			Lighting.AddLight(projectile.Center, new Vector3(.1f, .3f, .55f));
