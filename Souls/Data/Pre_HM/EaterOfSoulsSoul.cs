...
{
	public class EaterOfSoulsSoul : ISoul
	{
		public bool acquired { get; set; }

		public short soulNPC => NPCID.EaterofSouls;
		public string soulDescription => "Summons a friendly eater of souls.";
		...
		public bool SoulUpdate(Player p, short stack)
		{
			...
			for (int i = 0; i < Main.maxProjectiles; ++i)
				if (Main.projectile[i].active && Main.projectile[i].owner == p.whoAmI && Main.projectile[i].type == ProjectileType<EaterOfSoulsSoulProj>())
	...
	public class EaterOfSoulsSoulProj : ModProjectile
	{
		...
		public override string Texture => "Terraria/NPC_6";
