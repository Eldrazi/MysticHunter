...
{
	public class JungleSlimeSoul : PreHMSoul
	{
		...
		public override bool SoulUpdate(Player p, short stack)
		{
			...
			Projectile.NewProjectile(p.Center, velocity, ModContent.ProjectileType<JungleSlimeSoulProj>(), damage, .2f, p.whoAmI, bounceAmount);
