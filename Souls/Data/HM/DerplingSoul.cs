...
{
	public class DerplingSoul : PostHMSoul
	{
		public override short soulNPC => NPCID.Derpling;
		public override string soulDescription => "Summons a mini Derpling.";
	...
	public class DerplingSoulProj : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Derpling");
			Main.projFrames[projectile.type] = Main.npcFrameCount[NPCID.Derpling];
		}
