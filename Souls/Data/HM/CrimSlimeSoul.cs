...
namespace MysticHunter.Souls.Data.HM
{
	public class CrimSlimeSoul : PostHMSoul
	{
		...
		public override bool SoulUpdate(Player p, short stack)
		{
			...
			Projectile.NewProjectile(p.Center, velocity, ModContent.ProjectileType<CrimSlimeSoulProj>(), damage, .2f, p.whoAmI, bounceAmount);

			return (true);
		}
	}

	public class CrimSlimeSoulProj : ModProjectile
	{
		Vector2 bounceVelocity;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Crimson Blob");
		...
		public override bool PreAI()
		{
			...
			{
				Dust d = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 170)];
				d.noGravity = true;
			}
