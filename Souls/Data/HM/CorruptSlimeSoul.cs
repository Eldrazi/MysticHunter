...
{
	public class CorruptSlimeSoul : PostHMSoul
	{
		public override short soulNPC => NPCID.CorruptSlime;
		...
		public override bool SoulUpdate(Player p, short stack)
		{
			...
			Projectile.NewProjectile(p.Center, velocity, ModContent.ProjectileType<CorruptSlimeSoulProj>(), damage, .2f, p.whoAmI, bounceAmount);

			return (true);
		}
	}

	public class CorruptSlimeSoulProj : ModProjectile
	{
		Vector2 bounceVelocity;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Corrupt Blob");
		...
		public override bool PreAI()
		{
			...
			{
				Dust d = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 75)];
				d.noGravity = true;
			}
