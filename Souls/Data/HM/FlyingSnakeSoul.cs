...
{
	public class FlyingSnakeSoul : PostHMSoul
	{
		public override short soulNPC => NPCID.FlyingSnake;
		public override string soulDescription => "Summons a Flying Snake.";

		public override short cooldown => 900;
	...
	public class FlyingSnakeSoulProj : ModProjectile
	{
