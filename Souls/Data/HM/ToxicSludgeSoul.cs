...
{
	public class ToxicSludgeSoul : PostHMSoul
	{
		public override short soulNPC => NPCID.ToxicSludge;
		public override string soulDescription => "Fires a venomous slime blob.";

		public override short cooldown => 180;

		public override SoulType soulType => SoulType.Red;

		public override short ManaCost(Player p, short stack) => 18;
	...
	public class ToxicSludgeSoulProj : ModProjectile
	{
		Vector2 bounceVelocity;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Venomous Blob");
		...
		public override bool PreAI()
		{
			...
			{
				Dust d = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.GreenBlood)];
				d.noGravity = true;
			}
