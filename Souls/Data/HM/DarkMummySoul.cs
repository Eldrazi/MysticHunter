...
{
	public class DarkMummySoul : PostHMSoul
	{
		public override short soulNPC => NPCID.DarkMummy;
		public override string soulDescription => "Summons a shambling Dark Mummy.";
			...
			for (int x = minX; x <= maxX; ++x)
			{
				for (int y = minY; y <= maxY; ++y)
				{
					if (Main.myPlayer == projectile.owner && Main.tile[x, y] != null)
					{
						...
						else if (Main.tile[x, y].type == TileID.Pearlsand || Main.tile[x, y].type == TileID.Sand)
						{
						...
						else if (Main.tile[x, y].type == TileID.Pearlstone || Main.tile[x, y].type == TileID.Stone)
						{
						...
						else if (Main.tile[x, y].type == TileID.HallowedIce || Main.tile[x, y].type == TileID.IceBlock)
						{
						...
						else if (Main.tile[x, y].type == TileID.HallowHardenedSand || Main.tile[x, y].type == TileID.HardenedSand)
						{
						...
						else if (Main.tile[x, y].type == TileID.HallowSandstone || Main.tile[x, y].type == TileID.Sandstone)
						{
