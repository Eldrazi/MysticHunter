...
{
	public class HellbatSoul : ISoul
	{
		public bool acquired { get; set; }

		public short soulNPC => NPCID.Hellbat;
		public string soulName => "Hellbat";
		public string soulDescription => "Fire a spread of flaming bats.";
		...
		public bool SoulUpdate(Player p, short stack)
		{
			...
			for (int i = 0; i < amount; ++i)
			{
				...
				Projectile.NewProjectile(pos, velocity.RotatedByRandom(.2), ProjectileType<HellbatSoulProj>(), damage, 0, p.whoAmI);
			}
