...
namespace MysticHunter.Souls.Data.Event.FrostLegion
{
	...
	internal sealed class SantaMK1Soul_Proj : ModProjectile
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			{
				case 1:
					texture = ModContent.GetTexture(Texture).Value;
					break;

				case 2:
					texture = ModContent.GetTexture("MysticHunter/Souls/Data/Event/FrostMoon/SantaMK1Soul_Proj2").Value;
					break;

				default:
					texture = ModContent.GetTexture("MysticHunter/Souls/Data/Event/FrostMoon/SantaMK1Soul_Proj3").Value;
					break;
			}
