...
namespace MysticHunter.Souls.Data.Event.Sandstorm
{
	public class FleshReaverSoul : PostHMSoul, IEventSoul
	{
		...
		public override bool SoulUpdate(Player p, short stack)
		{
			...
			Projectile.NewProjectile(p.Center, velocity, ModContent.ProjectileType<FleshReaverSoulProj>(), damage, knockBack, p.whoAmI, 0, (stack >= 9 ? 1 : 0));
			return (true);
		}
	}
	...
	{
		public override string Texture => "Terraria/Images/NPC_" + NPCID.SandsharkCrimson;
