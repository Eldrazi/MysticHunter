...
{
	public class SandSharkSoul : PostHMSoul, IEventSoul
	{
		public override short soulNPC => NPCID.SandShark;
		public override string soulDescription => "Send out a charging Sand Shark.";
		...
		public override bool SoulUpdate(Player p, short stack)
		{
			...
			Projectile.NewProjectile(p.Center, velocity, ProjectileType<SandSharkSoulProj>(), damage, knockBack, p.whoAmI, 0, (stack >= 9 ? 1 : 0));
			return (true);
		}
	}

	internal sealed class SandSharkSoulProj : ModProjectile
	{
		public override string Texture => "Terraria/NPC_" + NPCID.SandShark;
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				Dust d = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Sandnado, -projectile.velocity.X * .2f, -projectile.velocity.Y * .2f, 100)];
				d.noGravity = true;
			}
		}
	}
