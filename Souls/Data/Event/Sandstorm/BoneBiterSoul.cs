...
{
	public class BoneBiterSoul : PostHMSoul, IEventSoul
	{
		public override short soulNPC => NPCID.SandsharkCorrupt;
		public override string soulDescription => "Send out a charging Bone Biter.";
	...
	internal sealed class BoneBiterSoulProj : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			for (int i = 0; i < 10; ++i)
			{
				Dust.NewDust(target.position, target.width, target.height, DustID.GreenBlood, projectile.velocity.X * .2f, projectile.velocity.Y * .2f, 100);
			}
		}
	}
}
