...
{
	public class SandSlimeSoul : ISoul
	{
		public bool acquired { get; set; }

		public short soulNPC => NPCID.SandSlime;
		public string soulName => "Sand Slime";
		public string soulDescription => "Fires a blinding, bouncing slime blob.";
		...
		public bool SoulUpdate(Player p, short stack)
		{
			...
			Projectile.NewProjectile(p.Center, velocity, ProjectileType<SandSlimeSoulProj>(), damage, .2f, p.whoAmI, bounceAmount);
