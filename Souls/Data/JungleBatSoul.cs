...
{
	public class JungleBatSoul : ISoul
	{
		public bool acquired { get; set; }

		public short soulNPC => NPCID.JungleBat;
		public string soulName => "Jungle Bat";
		public string soulDescription => "Fire a spread of poisonous bats.";
