...
{
	public class BlueSlimeSoul : ISoul
	{
		public bool acquired { get; set; }

		public short soulNPC => NPCID.BlueSlime;
		public string soulName => "Blue Slime";
		...
		public bool SoulUpdate(Player p, short stack)
		{
			...
			Projectile.NewProjectile(p.Center, velocity, ProjectileType<BlueSlimeSoulProj>(), damage, .2f, p.whoAmI, bounceAmount);

			return (true);
		}
	}

	public class BlueSlimeSoulProj : ModProjectile
	{
		Vector2 bounceVelocity;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Blue Blob");
